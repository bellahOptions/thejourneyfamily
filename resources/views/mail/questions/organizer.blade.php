    ...
    <body style="margin:0;background:#f7f4ee;color:#12211d;font-family:Arial,sans-serif;">
        <div style="max-width:640px;margin:0 auto;padding:32px 20px;">
            <div style="background:#ffffff;border:1px solid #d8cec0;border-radius:8px;padding:28px;">
                <p style="margin:0 0 8px;text-align:center;color:red;font-size:12px;font-weight:700;letter-spacing:2px;text-transform:uppercase;">New anonymous question</p>
                ...
                <p style="margin-top:20px;color:#68766f;font-size:13px;">
                    Submitted {{ $question->created_at->timezone(config('retreat.timezone'))->format('F j, Y g:i A') }} WAT. Feature it in the admin dashboard to show it on the live projector wall.
                </p>
            </div>
        </div>
    </body>
